...
test("when a partition key provided is greater than 256 characters, it would hash the partition key and use the hashed value", () => {
  const payload = {
    name: "benjamin",
    partitionKey:
      "",
  };

  const hash = crypto
    .createHash("sha3-512")
    .update(payload.partitionKey)
    .digest("hex");
